...
// Definicion de la Clase Carpeta (Folder) 
// ***************************************************************** 
...
{ 
  ...
  this.iconImg = 0; 
  this.nodeImg = 0;*/
  this.iconSrc = ICONPATH + "img/ftv2folderopen.gif";
  this.iconSrcClosed = ICONPATH + "img/ftv2folderclosed.gif";
  ...
  //methods 
  this.initialize = initializeFolder //Inicializa el menu en arbol 
  this.setState = setStateFolder //Muestra las Ramas del menu en arbol 
  this.addChild = addChild // Inicializa los nodos y los muestra 
  //this.addChildren = addChildren
  this.createIndex = createEntryIndex 
  this.escondeBlock = escondeBlock // Inicializa minimizar las opciones del menu en arbol
  this.esconde = escondeFolder // Permite volver a cerrar los nodos de las opciones del menu en arbol 
  this.folderMstr = folderMstr // Permite desplegar las opciones despues de la carpeta principal
  this.renderOb = drawFolder 
  //this.totalHeight = totalHeight 
  //this.subEntries = folderSubEntries 
  this.linkHTML = linkFolderHTML // Funcion que redirecciona los link de cada opcion
  this.blockStartHTML = blockStartHTML // Muesta e inicializa los link de los ejecutables
  this.blockEndHTML = blockEndHTML // Oculta y deshabilita los link de los ejecutables
  this.nodeImageSrc = nodeImageSrc // Inserta y muesta la linea vertical del arbol
  this.iconImageSrc = iconImageSrc // Inserta las imegenes a las opciones, carpetas, ejecutables etc....
  this.getID = getID // Almacena el id de cada objeto para realizar su respectiva funcion abir, cerrar o ejecutar
...
{ 
  ...
  if (this.level>0) 
    if (this.isLastNode) //the last child in the children array 
      ...
      leftSide = leftSide + "<td valign=top background=" + ICONPATH + "img/ftv2vertline.gif>" + auxEv + "<img name='nodeIcon" + this.id + "' id='nodeIcon" + this.id + "' src='" + nodeName + "' width=16 height=22 border=0></a></td>"
  ...
  {
	  if (this.prependHTML == "")
        docW = docW + "<img src=" + ICONPATH + "img/ftv2blank.gif height=2 width=2>"
  }
  if (WRAPTEXT)
...
function nodeImageSrc() {
  ...
  { 
    if (this.nChildren == 0)
      srcStr = ICONPATH + "img/ftv2lastnode.gif"
    else
      if (this.isOpen)
        srcStr = ICONPATH + "img/ftv2mlastnode.gif"  
      else
        srcStr = ICONPATH + "img/ftv2plastnode.gif"  
  } 
  else 
  { 
    if (this.nChildren == 0)
      srcStr = ICONPATH + "img/ftv2node.gif"
    else
      if (this.isOpen)
        srcStr = ICONPATH + "img/ftv2mnode.gif"
      else
        srcStr = ICONPATH + "img/ftv2pnode.gif"
  }   
  return srcStr;
}
...
function finalizeCreationOfItem(itemArray)
{
  ...
  itemArray.iconSrc = ICONPATH + "img/ftv2doc.gif" 
...
{ 
  ...
  if (this.level>0) 
    ...
    { 
      leftSide = leftSide + "<td valign=top><img src='" + ICONPATH + "img/ftv2lastnode.gif' width=16 height=22></td>"
    } 
    else 
    { 
      leftSide = leftSide + "<td valign=top background=" + ICONPATH + "img/ftv2vertline.gif><img src='" + ICONPATH + "img/ftv2node.gif' width=16 height=22></td>"
    } 
  ...
  if (USEICONS)
	  ...
	  if (this.prependHTML == "")
        docW = docW + "<img src=" + ICONPATH + "img/ftv2blank.gif height=2 width=3>"
...
function leftSideHTML(leftSideCoded) {
	...
	for (i=0; i<leftSideCoded.length; i++)
	{
		...
		{
			retStr = retStr + "<td valign=top background=" + ICONPATH + "img/ftv2vertline.gif><img src='" + ICONPATH + "img/ftv2vertline.gif' width=16 height=22></td>"
		}
		if (leftSideCoded.charAt(i) == "0")
		{
			retStr = retStr + "<td valign=top><img src='" + ICONPATH + "img/ftv2blank.gif' width=16 height=22></td>"
		}
	}
	return retStr
}
...
function preLoadIcons() {
       arImageSrc = new Array (
           "img/ftv2vertline.gif",
           "img/ftv2mlastnode.gif",
           "img/ftv2mnode.gif",
           "img/ftv2plastnode.gif",
           "img/ftv2pnode.gif",
           "img/ftv2blank.gif",
           "img/ftv2lastnode.gif",
           "img/ftv2node.gif",
           "img/ftv2folderclosed.gif",
           "img/ftv2folderopen.gif",
           "img/ftv2doc.gif"
           )
