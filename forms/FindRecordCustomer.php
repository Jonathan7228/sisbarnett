...
include_once '../classes/LogCustomer.php';
			...
			if(!empty($_POST['select']) && !empty($_POST['word'])){				
				$log= new LogCustomer('','','','','','','','','','');
				$resp=$log->FindLogCustomer($_POST['select'],$_POST['word']);
...
<head>
		...
		<title>Consultar Registro Clientes</title>
...
<body>
		...
		<table width="228" height="62" border="0">
		  <tr>
			...
			<td width="245"><a href="FindRecordCustomer.php"><img src="../img/buscar_lupa.png" alt="Buscar" width="30" height="30" title="Buscar"  /></a></td>
		  </tr>
		</table>
		<?php if($view_log == 0){?>
			  ...
			  <tr>
				...
				<table width="491" border="0" align="center" cellpadding="2" cellspacing="0" class="tablaformulario" >
				  ...
				  <tr align="center" class="colorbarratitulos">
					<td colspan="4" valign="middle" class="tamcolorletratitulos">CONSULTAR REGISTRO CLIENTE</td>
				  </tr>
				  <tr>
				  ...
				  <tr>
					...
					<td align="left" class="tamcolorletraformulario">*		<select name="select" id="select" style="height: 20px; width: 150px;" onchange="valcampobusqueda(this.value,'');">
                                <option value="txtDocumentCustomer">Documento Cliente</option>
								<option value="txtFirtsName">Nombre Cliente</option>
		...
		<?php }else{
			...
			<table width="900" border="1" align="center" cellpadding="0" cellspacing="0" class="tablaformulario">
								  ...
								  <tr>
									...
									<td width="228" align="center" valign="middle">&nbsp;</td>
									<td width="121" align="center" valign="middle">&nbsp;</td>
                                    <td width="139" align="center" valign="middle">&nbsp;</td>
								  </tr>
								  <tr class="colorbarratitulos">
									<td width="80" align="center" class="tamcolorletratitulostablaresul">Doc Usu.</td>
									<td width="212" align="center" class="tamcolorletratitulostablaresul">Nombre Usuario</td>
                                    <td width="106" align="center" class="tamcolorletratitulostablaresul">Doc. Cliente</td>
									<td width="228" align="center" class="tamcolorletratitulostablaresul">Nom. Cliente</td>
									<td width="121" align="center" class="tamcolorletratitulostablaresul">Descripcion</td>
								  ...
								  <?php
									...
									<tr align="left" class="TablaUsuarios">
										<td width="80"><?php echo $logCus->txtDocumentUser; ?></td>
										<td width="212"><?php echo $logCus->txtNameUser; ?></td>
                                        <td width="106"><?php echo $logCus->txtDocumentCustomer; ?></td>
                                        <td width="228"><?php echo $logCus->txtFirtsName.' '.$logCus->txtSecondName.' '.$logCus->txtLastName.' '.$logCus->txtSecondLastName; ?></td>
                                        <td width="121"><?php echo $logCus->txtDescription; ?></td>
                                        <td width="139"><?php echo $logCus->tmpDate; ?></td>
					  ...
					  <?php
									...
									echo "<script> window.location.href='FindRecordCustomer.php';</script>";
								}
							}
								?>
		</form>
