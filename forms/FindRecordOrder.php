...
include_once '../classes/LogOrder.php';
			...
			if(!empty($_POST['select']) && !empty($_POST['word'])){				
				$log= new LogOrder('','','','','','','');
				$resp=$log->FindLogOrder($_POST['select'],$_POST['word']);
...
<head>
		...
		<title>Consultar Registro Ordenes</title>
...
<body>
		...
		<table width="228" height="62" border="0">
		  <tr>
			...
			<td width="245"><a href="FindRecordOrder.php"><img src="../img/buscar_lupa.png" alt="Buscar" width="30" height="30" title="Buscar"  /></a></td>
		  </tr>
		</table>
		<?php if($view_log == 0){?>
			  ...
			  <tr>
				...
				<table width="491" border="0" align="center" cellpadding="2" cellspacing="0" class="tablaformulario" >
				  ...
				  <tr align="center" class="colorbarratitulos">
					<td colspan="4" valign="middle" class="tamcolorletratitulos">CONSULTAR REGISTRO ORDEN PEDIDO</td>
				  </tr>
				  <tr>
				  ...
				  <tr>
					...
					<td align="left" class="tamcolorletraformulario">*		<select name="select" id="select" style="height: 20px; width: 150px;" onchange="valcampobusqueda(this.value,'');">
                                <option value="intIdOrder">Numero Orden</option>
		...
		<?php }else{
			...
			<table width="900" border="1" align="center" cellpadding="0" cellspacing="0" class="tablaformulario">
								  ...
								  <tr class="colorbarratitulos">
                                    ...
                                    <td width="106" align="center" class="tamcolorletratitulostablaresul">Num. Orden</td>
								  ...
								  <?php
									...
									<tr align="left" class="TablaUsuarios">
										<td width="80"><?php echo $logOrd->txtDocumentUser; ?></td>
										<td width="188"><?php echo $logOrd->txtNameUser; ?></td>
                                      <td width="106"><?php echo $logOrd->intIdOrder; ?></td>
                                        <td width="136"><?php echo $logOrd->txtDescription; ?></td>
                                        <td width="139"><?php echo $logOrd->tmpDate; ?></td>
