		...
		<?php }else{
			...
			<table width="800" border="1" align="center" cellpadding="0" cellspacing="0" class="tablaformulario">
								  ...
								  <tr class="colorbarratitulos">
									...
									<td width="60" align="center" class="tamcolorletratitulostablaresul">Seleccionar</td>
								  </tr>
								  <?php
									...
									<tr align="left" class="TablaUsuarios">
										...
										<td width="60" align="center" valign="middle"><a href="javascript:send_form_edit('edit','<?php echo $cus->intId; ?>','0')" title="Editar Informacion"><img src="../img/seleccionar.png" width="30" height="30" /><a></td>
