...
include_once '../classes/ProductOrder.php';
			...
			if(!empty($_POST['select']) && !empty($_POST['word'])){
				$order= new Order('','','','','','');
				$resp=$order->FindOrder($_POST['select'],$_POST['word']);
			  ...
			  <tr>
				...
				<table width="491" border="0" align="center" cellpadding="2" cellspacing="0" class="tablaformulario" >
				  ...
				  <tr align="center" class="colorbarratitulos">
					<td colspan="4" valign="middle" class="tamcolorletratitulos">BUSCAR ORDEN DE PEDIDO</td>
					</tr>
				  <tr>
				  ...
				  <tr>
					...
					<td align="left" class="tamcolorletraformulario">*		<select name="select" id="select" style="height: 20px; width: 150px;" onchange="valcampobusqueda(this.value,'');">
								<option value="intId">Numero Orden</option>
		...
		<?php }else{
			...
			<table width="800" border="1" align="center" cellpadding="0" cellspacing="0" class="tablaformulario">
								  ...
								  <tr>
									...
									<td width="123">&nbsp;</td>
									<td width="316" align="center" valign="middle">&nbsp;</td>
								  ...
								  <tr class="colorbarratitulos">
									...
									<td width="123" align="center" class="tamcolorletratitulostablaresul">Doc Cliente</td>
									<td width="316" align="center" class="tamcolorletratitulostablaresul">Nombre Cliente</td>
                                    <td width="141" align="center" class="tamcolorletratitulostablaresul">Fecha</td>
                                    <td width="66" align="center" class="tamcolorletratitulostablaresul">Estado</td>
									<td width="57" align="center" class="tamcolorletratitulostablaresul">Ver</td>
								  </tr>
								  <?php
									for ($i=0; $i<count($resp); $i++){
										$op = $resp[$i];
										$customer = new Customer('','','','','','','','','','','','','','','','');
										$cus = $customer->FindCustomer('id',$op->intIdCustomer);
									?>
									<tr align="left" class="TablaUsuarios">
										<td width="83" align="center"><?php echo ($op->intId); ?></td>
                                        <td width="123"><?php echo ($cus[0]->txtDocument); ?></td>
										<td width="316"><?php echo ($cus[0]->txtFirtsName.' '.$cus[0]->txtSecondName.' '.$cus[0]->txtLastName.' '.$cus[0]->txtSecondLastName); ?></td> 
                                        <td width="141" align="center"><?php echo ($op->tmpDate); ?></td>
										<td width="66" align="center" valign="middle"><?php if($op->intState==1){echo "ACTIVA";}else{echo "ANULADA";} ?></td>
										<td width="57" align="center" valign="middle"><a href="javascript:send_form_edit('edit','<?php echo $op->intId; ?>','0')" title="Editar Informacion"><img src="../img/seleccionar.png" width="25" height="25" /><a></td>
					  ...
					  <?php
									...
									echo "<script> window.location.href='SelectFindOrder.php';</script>";
								}
							}
								?>
		</form>
